...
import './Registration.css'; // Убедитесь, что путь к стилям правильный
      ...
      <section className="registration center">
        <form className="registration__data">
          <div className="registration__inputs">
            ...
            <input className="registration__input" type="text" placeholder="First Name" required />
            <input className="registration__input" type="text" placeholder="Last Name" required />
          </div>

          <div className="registration__checkboxes">
            <input className="registration__checkbox" type="radio" id="checkbox1" name="gender" />
            <label className="registration__label" htmlFor="checkbox1">Male</label>

            <input className="registration__checkbox" type="radio" id="checkbox2" name="gender" />
            <label className="registration__label" htmlFor="checkbox2">Female</label>
          </div>
          ...
          <p className="registration__text">Please use 8 or more characters, with at least 1 number and a <br />
        ...
        <div className="registration__info">
          ...
          <ul className="registration__column">
            ...
            <li className="registration__li">Free shipping, returns and exchanges on all orders</li>
            <li className="registration__li">$10 off a purchase on your birthday</li>
